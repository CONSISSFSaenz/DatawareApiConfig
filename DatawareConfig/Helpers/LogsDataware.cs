...
namespace DatawareConfig.Helpers
{
    public static class LogsDataware
    {
        ...
        public static string CnxStrDb()
        {
            ...
            string cnxAzure = "Server=consissqa.database.windows.net;Initial Catalog=DataWare_QA;MultipleActiveResultSets=true;User Id=administrador;password=C0nsiss2022+;Connection Timeout=12000";
            return cnxAzure;
        }
